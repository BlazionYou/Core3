...
object_draft_schematic_structure_dathomir_house_player_small = object_draft_schematic_structure_shared_generic_house_player_small:new {

	templateType = DRAFTSCHEMATIC,

	customObjectName = "Deed for: Small Dathomir House",
	...
	targetTemplate = "object/tangible/deed/player_house_deed/dathomir_house_small_deed.iff",

	additionalTemplates = {}
}
ObjectTemplates:addTemplate(object_draft_schematic_structure_dathomir_house_player_small, "object/draft_schematic/structure/dathomir_house_player_small.iff")
