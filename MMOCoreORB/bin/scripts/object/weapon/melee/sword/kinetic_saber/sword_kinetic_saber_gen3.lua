...
ObjectTemplates:addTemplate(object_weapon_melee_sword_kinetic_saber_sword_kinetic_saber_gen3, "object/weapon/melee/sword/kinetic_saber/shared_kinetic_saber_gen3.iff")
